...
//			[snapBackArrow dissolveToPoint:[self _snapbackRectForFrame: cellFrame].origin fraction:1.0f];
			[snapBackArrow drawAtPoint:[self _snapbackRectForFrame: cellFrame].origin fromRect:NSMakeRect(0, 0, snapBackArrow.size.width, snapBackArrow.size.height) operation:NSCompositeSourceOver fraction:1.0f];
...
//				[removeImage dissolveToPoint:[self _removeButtonRectForFrame: cellFrame].origin fraction:1.0f];
				[removeImage drawAtPoint:[self _removeButtonRectForFrame: cellFrame].origin fromRect:NSMakeRect(0, 0, removeImage.size.width, removeImage.size.height) operation:NSCompositeSourceOver fraction:1.0f];
...
//			[snapBackArrow dissolveToPoint:correctedSnapBackOrigin fraction:1.0f*alphaRecording];
			[snapBackArrow drawAtPoint:correctedSnapBackOrigin fromRect:NSMakeRect(0, 0, snapBackArrow.size.width, snapBackArrow.size.height) operation:NSCompositeSourceOver fraction:1.0f*alphaRecording];
...
//			[removeImage dissolveToPoint:[viewportMovement transformPoint:([self _removeButtonRectForFrame: cellFrame].origin)] fraction:alphaView];
			[removeImage drawAtPoint:[viewportMovement transformPoint:([self _removeButtonRectForFrame: cellFrame].origin)] fromRect:NSMakeRect(0, 0, removeImage.size.width, removeImage.size.height) operation:NSCompositeSourceOver fraction:alphaView];
